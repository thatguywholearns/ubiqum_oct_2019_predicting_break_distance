...
#Store coefficients final model
...
ggplot(test_set, aes(x = speed_of_car_squared, y = distance_of_car)) + geom_point() + geom_abline(intercept = lm_model1_intercept, slope = lm_model1_coef1)
